    ...
    const transaction = await aptos.transaction.build.simple(
        {
            ...
            data: {
                function: `${devAccount.accountAddress}::market::create_sale`,
    ...
    const transaction = await aptos.transaction.build.simple(
        {
            sender: devAccount.accountAddress,
            data: {
                function: `${devAccount.accountAddress}::market::buy`,
    ...
    const transaction = await aptos.transaction.build.simple(
        {
            ...
            data: {
                function: `${devAccount.accountAddress}::market::delete_sale`,
                functionArguments: [saleId]
            }
        }
    );
    ...
    const transaction = await aptos.transaction.build.simple(
        {
            sender: account.accountAddress,
            data: {
                function: `${devAccount.accountAddress}::market::update_sale_name`,
...
async function get_sales() {
    const salesResults = await aptos.view({
        payload: {
            function: `${devAccount.accountAddress}::market::get_sales`,
            typeArguments: [],
            functionArguments: [],
        },
    });
...
describe('update sale', () => {
    ...
    it('should NOT allow NON authorized account to update sale name', async function () {
        ...
        try {
            ...
            const expectedError = 'Move abort in 0x2de6aea32fcb7ab2e33ab9a78df3b5f4ef5b718ef77475f96ed8a66f466afc28::market: 0x6';
...
describe('delete_sale', () => {
    ...
    before(async function() {
        ...
        await create_sale(Object.values(saleData));
    ...
    it('should NOT allow NON authorized account to delete sale', async function () {
        ...
        try {
            ...
            const expectedError = 'Move abort in 0x2de6aea32fcb7ab2e33ab9a78df3b5f4ef5b718ef77475f96ed8a66f466afc28::market: 0x1';
            expect(error.transaction.vm_status).to.equal(expectedError);
        }
    })
